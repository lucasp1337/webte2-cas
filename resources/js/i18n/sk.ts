const skSource = {
    ...
    console: {
        ...
        run: 'Spustiť',
        running: 'Beží…',
        clear: 'Vyčistiť reláciu',
        clearing: 'Čistím…',
        outputTitle: 'Výstup',
        outputEmpty: 'Žiadne výstupy zatiaľ.',
        variablesTitle: 'Pracovný priestor',
        variablesEmpty: 'Žiadne premenné. Spustite príkaz vyššie.',
        variablesEmptySub: 'Premenné sa zobrazia tu po vykonaní.',
        ...
        bridgeUnavailable: 'Octave most je nedostupný',
        bridgeUnavailableDetail1: 'Zlyhalo spojenie s /api/v1/octave/exec',
        bridgeUnavailableDetail2: 'Skontrolujte, či služba beží.',
        ...
        runShortcutHint: 'Ctrl+Enter na spustenie',
        sessionLabel: 'Relácia',
        outputLabel: 'Výstup',
        newestFirst: 'najnovšie na vrchu',
        tryHint: 'Začnite tu',
        insertExample: 'Vložiť príklad',
        retry: 'Skúsiť znova',
    ...
    pendulum: {
        ...
        parametersReset: 'Obnoviť predvolené',
        presetsLabel: 'Prednastavenia',
        simulationTitle: 'Simulácia',
        chartTitle: 'Trajektória',
        replayLabel: 'Prehrávanie',
        runButton: 'Spustiť simuláciu',
        runningLabel: 'Simuluje sa…',
        idleStatus: 'pripravené',
        okStatus: 'ok',
        errorStatus: 'chyba',
        emptyTitle: 'Žiadna simulácia',
        emptySub: 'Spustite simuláciu pre zobrazenie animácie.',
        errorTitle: 'Simulácia zlyhala',
        errorSub: 'Octave bridge zlyhal pri riešení ODE.',
        time: 't',
        frame: 'snímka',
        form: {
